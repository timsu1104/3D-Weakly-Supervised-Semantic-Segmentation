...
# PointNet layers used in backbone construction -- PointnetSAModuleVotes, PointnetFPModule
from pointnet2.pointnet2_modules import PointnetSAModuleVotes, PointnetFPModule

class Pointnet2Backbone(nn.Module):
    r"""Backbone network for point cloud feature learning.
    ...
    def __init__(self, input_feature_dim=0):
        ...
        # self.sa1 - self.sa4 -- 4 Set Abstracton layers 
        ...
        # self.fp1 - self.fp2 -- 2 Feature Propagation layers
        self.fp1 = PointnetFPModule(mlp=[256+256,256,256])
        self.fp2 = PointnetFPModule(mlp=[256+256,256,256])

    def _break_up_pc(self, pc):
        # xyz -- 3 dimentonal coordinates
