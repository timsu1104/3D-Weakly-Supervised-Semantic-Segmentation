...
import sys
sys.path.append('/home/zhuhe/3DNetWithText_v10.9/3DUNetWithText/models/wypr_backbone/pointnet2')
...
def UpsampleModule(unknown: torch.Tensor, known: torch.Tensor, known_feats: torch.Tensor):
    r"""Propigates the features of one set to another
        Parameters
        ----------
        unknown : torch.Tensor
