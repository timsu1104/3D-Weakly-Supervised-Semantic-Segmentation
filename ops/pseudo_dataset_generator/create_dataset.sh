...
# python -u Image_generator.py --config data_generation_config/refrigerator_with_white_bg.yaml --device_num 1 --total_device 6 > logs/partial_log1.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/refrigerator_with_white_bg.yaml --device_num 2 --total_device 6 > logs/partial_log2.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/refrigerator_with_white_bg.yaml --device_num 3 --total_device 6 > logs/partial_log3.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/refrigerator_with_white_bg.yaml --device_num 4 --total_device 6 > logs/partial_log4.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/refrigerator_with_white_bg.yaml --device_num 5 --total_device 6 > logs/partial_log5.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/refrigerator_with_white_bg.yaml --device_num 6 --total_device 6 > logs/partial_log6.log 2>&1 &

# python -u Image_generator.py --config data_generation_config/table_with_white_bg.yaml --device_num 1 --total_device 6 > logs/partial_log1.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/table_with_white_bg.yaml --device_num 2 --total_device 6 > logs/partial_log2.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/table_with_white_bg.yaml --device_num 3 --total_device 6 > logs/partial_log3.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/table_with_white_bg.yaml --device_num 4 --total_device 6 > logs/partial_log4.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/table_with_white_bg.yaml --device_num 5 --total_device 6 > logs/partial_log5.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/table_with_white_bg.yaml --device_num 6 --total_device 6 > logs/partial_log6.log 2>&1 &

# python -u Image_generator.py --config data_generation_config/bathtub_with_green_bg.yaml --device_num 1 --total_device 6 > logs/log_bathtub/partial_log1.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/bathtub_with_green_bg.yaml --device_num 2 --total_device 6 > logs/log_bathtub/partial_log2.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/bathtub_with_green_bg.yaml --device_num 3 --total_device 6 > logs/log_bathtub/partial_log3.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/bathtub_with_green_bg.yaml --device_num 4 --total_device 6 > logs/log_bathtub/partial_log4.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/bathtub_with_green_bg.yaml --device_num 5 --total_device 6 > logs/log_bathtub/partial_log5.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/bathtub_with_green_bg.yaml --device_num 6 --total_device 6 > logs/log_bathtub/partial_log6.log 2>&1 &

# python -u Image_generator.py --config data_generation_config/toilet_with_green_bg.yaml --device_num 1 --total_device 6 > logs/log_toilet/partial_log1.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/toilet_with_green_bg.yaml --device_num 2 --total_device 6 > logs/log_toilet/partial_log2.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/toilet_with_green_bg.yaml --device_num 3 --total_device 6 > logs/log_toilet/partial_log3.log 2>&1 &
# python -u Image_generator.py --config data_generation_config/toilet_with_green_bg.yaml --device_num 4 --total_device 6 > logs/log_toilet/partial_log4.log 2>&1 &
